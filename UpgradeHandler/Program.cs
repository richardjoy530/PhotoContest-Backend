...
namespace UpgradeHandler
{
    internal abstract class Program
    {
        ...
        private static readonly string _connectionString = "Server=localhost;Database=FridayDatabase;Trusted_Connection=yes;";
        ...
        private static Submission ParseDataSubmission(System.Data.IDataRecord record)
        {
            if (record is null)
                throw new ArgumentNullException(nameof(record));
