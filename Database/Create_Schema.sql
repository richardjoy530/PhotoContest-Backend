...
ALTER TABLE dbo.PhotoEntry ADD CONSTRAINT fk_photoentry_photographer FOREIGN KEY ( PhotographerId ) REFERENCES dbo.Photographer( Id );
GO

ALTER TABLE dbo.PhotoEntry ADD CONSTRAINT fk_photoentry_phototheme FOREIGN KEY ( ThemeId ) REFERENCES dbo.PhotoTheme( Id );
GO

ALTER TABLE dbo.PhotoEntry ADD CONSTRAINT fk_photoentry_filemap FOREIGN KEY ( FileId ) REFERENCES dbo.FileMap( Id );
GO

ALTER TABLE dbo.PhotographerVoteDetails ADD CONSTRAINT fk_photographervotedetails_phototheme FOREIGN KEY ( ThemeId ) REFERENCES dbo.PhotoTheme( Id );
GO

ALTER TABLE dbo.PhotographerVoteDetails ADD CONSTRAINT fk_photographervotedetails_photographer FOREIGN KEY ( PhotographerId ) REFERENCES dbo.Photographer( Id );
GO

ALTER TABLE dbo.PhotographerVoteDetails ADD CONSTRAINT fk_photographervotedetails_firstvote FOREIGN KEY ( FirstId ) REFERENCES dbo.PhotoEntry( Id );
GO

ALTER TABLE dbo.PhotographerVoteDetails ADD CONSTRAINT fk_photographervotedetails_secondvote FOREIGN KEY ( SecondId ) REFERENCES dbo.PhotoEntry( Id );
GO

ALTER TABLE dbo.PhotographerVoteDetails ADD CONSTRAINT fk_photographervotedetails_thirdvote FOREIGN KEY ( ThirdId ) REFERENCES dbo.PhotoEntry( Id );
GO

ALTER TABLE dbo.ScoreDetail ADD CONSTRAINT fk_scoredetail_photoentry FOREIGN KEY ( EntryId ) REFERENCES dbo.PhotoEntry( Id );
GO
