...
namespace PhotoContest.Implementation.Ado.Providers
{
    ...
    public class ScoreInfoProvider : IScoreInfoProvider
    {
        ...
        public ScoreInfoProvider(IDatabase dbConnection)
        {
